$(function() {
  const PARENT_FACE_X = '278px'; // Distance of face hole from left. Gross.
  const PARENT_FACE_Y = '138px' // Distance of face hole from top. Gross.
  const PARENT_FACE_HEIGHT = '107px' // The height of the face hole. Gross.
  const PARENT_FACE_WIDTH = 95; // The width of the face hole. Gross.
